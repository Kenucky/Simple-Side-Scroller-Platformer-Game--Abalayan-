class Level1 extends Phaser.Scene {
  ...
  create() {
    ...
    groundLayer.setCollisionBetween(6,55);
    obstaclesLayer.setCollisionBetween(30,40);
  ...
  reachGoal(player, goal) {
    this.scene.start('Level2', { lives: this.lives });
  }
  ...
  loseLife() {
    ...
    if (this.lives <= 0) {
      ...
      this.time.delayedCall(1000, () => {
        ...
        this.player.setPosition(100, 370); // reset position
